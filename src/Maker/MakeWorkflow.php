...
use InterInvest\ClientApiPer\Handler\EventMessageInterface;
use InterInvest\ClientApiPer\Workflow\WorkflowInterface;
...
class MakeWorkflow implements MakerInterface
{
    ...
    public function generate(InputInterface $input, ConsoleStyle $io, Generator $generator): void
    {
        ...
        use InterInvest\ClientApiPer\Handler\EventMessageInterface;
        use InterInvest\ClientApiPer\Workflow\WorkflowInterface;
        use InterInvest\ClientApiPer\Workflow\AbstractWorkflow;
